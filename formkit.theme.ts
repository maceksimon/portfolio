...
/**
  ...
  * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=neutral,spacing=2,scale=sm,inputShadow=shadow-sm,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
