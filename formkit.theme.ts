...
/**
  ...
  *
  * @checksum - 6c7013bd7af8357986d1b562320e73985a89a2d9c96347f8ddf3d122fe821e6b
  * @variables - radius=rounded-lg,accentColor=purple,colorTemperature=neutral,spacing=2,scale=sm,inputShadow=shadow-sm,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
