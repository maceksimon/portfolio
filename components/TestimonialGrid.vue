<template>
  <div class="relative isolate mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-16">
    ...
    <div>
      ...
      <div
        class="mx-auto mt-16 grid grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-50 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-3">
...
<i18n lang="json">{
  "cs": {
    "highlight": "Co na to moje klientstvo",
    "title": "Reference od těch, kdo mi svěřili svůj projekt"
  },
  "en": {
