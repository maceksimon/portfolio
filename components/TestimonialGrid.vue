  ...
  <div class="relative isolate pb-32 pt-24 sm:pt-32">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-xl text-center">
        <h2 class="text-lg font-semibold leading-8 tracking-tight text-purple-300">{{ $t('testimonials.highlight') }}</h2>
        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-50 sm:text-4xl">{{ $t('testimonials.title') }}</p>
      </div>
      <div
        class="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-50 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
