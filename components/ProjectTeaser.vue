    ...
    <div class="relative sm:col-span-4">
      ...
      <div class="absolute right-[20%] bottom-0 pointer-events-none" aria-hidden="true">
        <svg viewBox="0 0 366 729" role="img" class="mx-auto w-[12rem] max-w-full drop-shadow-xl">
          ...
          <foreignObject width="316" height="684" transform="translate(24 24)"
            clip-path="url(#2ade4387-9c63-4fc4-b754-10e687a0d332)"><img :src="selectedMailingLists.imageMobile" alt="" />
          </foreignObject>
        </svg>
      </div>
      <!-- Mockup desktop -->
      <div>
        <svg width="600" height="482" viewBox="0 0 1442 1281" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <rect x="843" y="1223" width="44" height="7" rx="1" fill="url(#paint1_linear_7_520)" />
          <rect width="346" height="223" transform="matrix(-1 0 0 1 893 993)" fill="url(#paint2_linear_7_520)" />
          <rect width="1440" height="997" rx="24" transform="matrix(-1 0 0 1 1442 1)" fill="#505254" />
          <rect width="1440" height="999" rx="24" transform="matrix(-1 0 0 1 1440 0)" fill="url(#paint3_linear_7_520)" />
          <path d="M1440 851H0V975C0 988.255 10.7451 999 24 999H1416C1429.25 999 1440 988.255 1440 975V851Z"
            fill="url(#paint4_linear_7_520)" />
          <circle cx="8" cy="8" r="8" transform="matrix(-1 0 0 1 752 9)" fill="#343747" />
          <g filter="url(#filter3_i_7_520)">
            <circle cx="4" cy="4" r="4" transform="matrix(-1 0 0 1 748 13)" fill="url(#paint5_radial_7_520)" />
          </g>
          <rect width="346" height="15" transform="matrix(-1 0 0 1 893 1212)" fill="url(#paint6_linear_7_520)" />
          ...
          <foreignObject width="1372" height="783" transform="translate(34 34)"
            clip-path="url(#2ade4387-9c63-4fc4-b754-10e687a0d333)"><img :src="selectedMailingLists.imageDesktop" alt="" />
          </foreignObject>
          <path d="M84 851L918 0H1416C1429.25 0 1440 10.7452 1440 24V851H84Z" fill="url(#paint7_linear_7_520)" />
          <defs>
            <filter id="filter0_f_7_520" x="42" y="1188" width="1356.49" height="62.4758" filterUnits="userSpaceOnUse"
            ...
            <filter id="filter2_f_7_520" x="523" y="1219" width="395" height="62" filterUnits="userSpaceOnUse"
              color-interpolation-filters="sRGB">
              <feFlood flood-opacity="0" result="BackgroundImageFix" />
              <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
              <feGaussianBlur stdDeviation="10" result="effect1_foregroundBlur_7_520" />
            </filter>
            <filter id="filter3_i_7_520" x="740" y="12" width="8" height="9" filterUnits="userSpaceOnUse"
              color-interpolation-filters="sRGB">
              <feFlood flood-opacity="0" result="BackgroundImageFix" />
              <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
              ...
              <feColorMatrix type="matrix" values="0 0 0 0 0.0392157 0 0 0 0 0.0431373 0 0 0 0 0.0509804 0 0 0 1 0" />
              <feBlend mode="normal" in2="shape" result="effect1_innerShadow_7_520" />
            </filter>
            <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
              <use xlink:href="#image0_7_520" transform="matrix(0.0004 0 0 0.000700894 0 -0.0845456)" />
            </pattern>
            <linearGradient id="paint0_linear_7_520" x1="575" y1="1223" x2="575" y2="1230" gradientUnits="userSpaceOnUse">
              <stop stop-color="#19191A" />
              <stop offset="1" stop-color="#636569" />
            </linearGradient>
            <linearGradient id="paint1_linear_7_520" x1="865" y1="1223" x2="865" y2="1230" gradientUnits="userSpaceOnUse">
              <stop stop-color="#19191A" />
              <stop offset="1" stop-color="#636569" />
            </linearGradient>
            <linearGradient id="paint2_linear_7_520" x1="173" y1="0" x2="173" y2="223" gradientUnits="userSpaceOnUse">
              <stop stop-color="#303236" />
              <stop offset="0.873392" stop-color="#8C8F93" />
              <stop offset="0.924622" stop-color="#BABABA" />
              <stop offset="0.957999" stop-color="#999B9E" />
              <stop offset="0.992152" stop-color="#4D4D4D" />
            </linearGradient>
            <linearGradient id="paint3_linear_7_520" x1="1399.5" y1="-0.000109302" x2="483" y2="862.5"
            ...
            <radialGradient id="paint5_radial_7_520" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
              gradientTransform="translate(4 4) rotate(90) scale(4)">
              <stop stop-color="#55A0FF" />
              <stop offset="0.513343" stop-color="#214D89" />
              <stop offset="1" stop-color="#10182A" />
            </radialGradient>
            <linearGradient id="paint6_linear_7_520" x1="346" y1="15.0001" x2="-1.64163e-05" y2="16.0001"
              gradientUnits="userSpaceOnUse">
              <stop stop-color="#727476" />
              <stop offset="0.0196622" stop-color="#B6B6B9" />
              <stop offset="0.0393102" stop-color="#66696D" />
              <stop offset="0.0913451" stop-color="#898A8F" />
              <stop offset="0.948172" stop-color="#898A8F" />
              <stop offset="0.977921" stop-color="#66696D" />
              <stop offset="0.991869" stop-color="#B6B6B9" />
              <stop offset="1" stop-color="#727476" />
            </linearGradient>
            <linearGradient id="paint7_linear_7_520" x1="853.213" y1="34" x2="853.213" y2="820"
              gradientUnits="userSpaceOnUse">
      ...
      <div class="mt-4 grid grid-cols-1 gap-y-6">
        <RadioGroupOption as="template" v-for="project in projects" :key="project.id" :value="project"
          ...
          <div
            ...
            <Icon class="h-5 w-5 text-red-800/75 dark:text-red-100/50" aria-hidden="true" name="heroicons:check-circle" />
            <span
